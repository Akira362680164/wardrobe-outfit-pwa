...
- 不提交模型权重。当前 u2netp 测试文件 SHA-256 为 `309c8469258dda742793dce0ebea8e6dd393174f89934733ecc8b14c76f4ddd8`；正式启用前必须完成权重来源/分发许可证书面审核，通过部署配置注入审核过的文件，并配置私网常驻 sidecar、无公网、硬超时、并发/队列与健康检查。

...
export const metadata: Metadata = { title: "联系我们", description: "联系 Wardora 处理账号、数据、隐私、注销与安全问题。", alternates: { canonical: absoluteSiteUrl("/contact/") } };
      ...
      <main className="site-legal-main">
        <article className="site-reading">
          ...
          <div className="site-legal-sections">
            <section><h2>产品信息</h2><p>产品名称：Wardora</p><p>服务类型：个人衣橱与穿搭管理工具</p><p>运营主体：{siteStatus.operatorLabel}</p></section>

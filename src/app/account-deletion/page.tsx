...
export const metadata: Metadata = { title: "账号注销说明", description: `${siteConfig.productName}账号注销影响、数据删除范围与申请渠道。`, alternates: { canonical: absoluteSiteUrl("/account-deletion/") } };

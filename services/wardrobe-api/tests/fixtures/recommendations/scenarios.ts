...
const BASE_GARMENTS: RecommendationGarment[] = [
  garment(IDS.shirt, "tops", { subcategory: "shirt", colors: ["white"], styles: ["commute"], formality: 4, temperatureMinC: 12, temperatureMaxC: 28 }),
  garment(IDS.tee, "tops", { subcategory: "t_shirt", colors: ["white"], styles: ["casual", "outdoor"], formality: 1, warmth: 1, temperatureMinC: 22, temperatureMaxC: 42 }),
  garment(IDS.sweater, "tops", { subcategory: "sweater_knit", colors: ["navy"], styles: ["commute"], formality: 3, warmth: 4, temperatureMinC: -2, temperatureMaxC: 16 }),
  garment(IDS.rainCoat, "tops", { subcategory: "trench_coat", colors: ["navy"], styles: ["commute"], formality: 3, material: "polyester", warmth: 3, temperatureMinC: 8, temperatureMaxC: 24 }),
  garment(IDS.downCoat, "tops", { subcategory: "down_jacket", colors: ["black"], styles: ["casual"], formality: 2, warmth: 5, temperatureMinC: -30, temperatureMaxC: 8 }),
  garment(IDS.blazer, "tops", { subcategory: "suit_jacket", colors: ["black"], styles: ["commute", "elegant"], formality: 5, warmth: 3, temperatureMinC: 8, temperatureMaxC: 24 }),
  garment(IDS.pants, "pants", { subcategory: "suit_pants", styles: ["commute"], formality: 4, temperatureMinC: 8, temperatureMaxC: 30 }),
  garment(IDS.shorts, "pants", { subcategory: "casual_shorts", colors: ["blue"], styles: ["casual", "outdoor"], formality: 1, warmth: 1, temperatureMinC: 24, temperatureMaxC: 45 }),
  garment(IDS.skirt, "skirts", { subcategory: "a_line_skirt", colors: ["navy"], styles: ["elegant", "commute"], formality: 3, temperatureMinC: 15, temperatureMaxC: 32 }),
  garment(IDS.dress, "one_piece", { subcategory: "dress", colors: ["navy"], styles: ["elegant"], formality: 4, temperatureMinC: 16, temperatureMaxC: 30 }),
  garment(IDS.sneakers, "shoes", { subcategory: "sneakers", colors: ["white"], styles: ["casual", "outdoor"], formality: 1, material: "mesh", warmth: 1, temperatureMinC: 12, temperatureMaxC: 42 }),
  ...
  garment(IDS.sandals, "shoes", { subcategory: "sandals", colors: ["beige"], formality: 1, warmth: 1, temperatureMinC: 24, temperatureMaxC: 45 }),
  garment(IDS.bag, "bags", { subcategory: "fashion_bag", styles: ["commute"], formality: 4 }),
  garment(IDS.hat, "hats", { subcategory: "sun_hat", colors: ["beige"], styles: ["outdoor"], formality: 1 }),
];
...
export const recommendationScenarioFixtures: RecommendationScenarioFixture[] = [
  ...
  fixture("other_user_filtered", "非本用户", input({ garments: [...BASE_GARMENTS, garment(IDS.otherUser, "tops", { userId: OTHER_USER })] }), { ...defaultReady, mustExclude: [IDS.otherUser], exclusionCodes: ["not_current_user"] }),
  fixture("deleted_filtered", "deleted", input({ garments: [...BASE_GARMENTS, garment(IDS.deleted, "tops", { deleted: true })] }), { ...defaultReady, mustExclude: [IDS.deleted], exclusionCodes: ["deleted"] }),
  fixture("archived_filtered", "archived", input({ garments: [...BASE_GARMENTS, garment(IDS.archived, "tops", { status: "archived" })] }), { ...defaultReady, mustExclude: [IDS.archived], exclusionCodes: ["unavailable_status"] }),
  fixture("laundry_filtered", "laundry", input({ garments: [...BASE_GARMENTS, garment(IDS.laundry, "tops", { status: "laundry" })] }), { ...defaultReady, mustExclude: [IDS.laundry], exclusionCodes: ["unavailable_status"] }),
  fixture("repair_filtered", "repair", input({ garments: [...BASE_GARMENTS, garment(IDS.repair, "tops", { status: "repair" })] }), { ...defaultReady, mustExclude: [IDS.repair], exclusionCodes: ["unavailable_status"] }),
  fixture("missing_image_filtered", "缺主图", input({ garments: [...BASE_GARMENTS, garment(IDS.noImage, "tops", { hasPrimaryImage: false })] }), { ...defaultReady, mustExclude: [IDS.noImage], exclusionCodes: ["missing_primary_image"] }),
  fixture("missing_required_fields", "缺必要字段", input({ garments: [...BASE_GARMENTS, garment(IDS.missingFields, undefined, { colors: [], seasons: [], warmth: undefined, temperatureMinC: undefined, temperatureMaxC: undefined, formality: undefined })] }), { ...defaultReady, mustExclude: [IDS.missingFields], exclusionCodes: ["missing_required_field"] }),
  fixture("thermal_severe_mismatch", "温度严重不符", input({ garments: [...BASE_GARMENTS, garment(IDS.thermalMismatch, "tops", { temperatureMinC: -30, temperatureMaxC: 5 })] }), { ...defaultReady, mustExclude: [IDS.thermalMismatch], exclusionCodes: ["temperature_mismatch"] }),
  fixture("formality_severe_mismatch", "正式度严重不符", input({ garments: [...BASE_GARMENTS, garment(IDS.formalMismatch, "tops", { formality: 1 })], dateContextInput: { ...input().dateContextInput, travelPlan: { name: "Formal", destination: "Shanghai", activities: ["formal gala"] } } }), { ...defaultReady, mustExclude: [IDS.formalMismatch], exclusionCodes: ["formality_mismatch"] }),
  fixture("avoid_rule", "avoid rule", input({ garments: [...BASE_GARMENTS, garment(IDS.suede, "shoes", { material: "suede" })], dateContextInput: { ...input().dateContextInput, weatherEvidence: { ...input().dateContextInput.weatherEvidence, rainProbability: 90, summary: "rain" } } }), { ...defaultReady, mustExclude: [IDS.suede], exclusionCodes: ["avoid_rule"] }),
  fixture("explicit_block", "明确禁止推荐", input({ garments: [...BASE_GARMENTS, garment(IDS.blocked, "tops", { recommendationBlocked: true })] }), { ...defaultReady, mustExclude: [IDS.blocked], exclusionCodes: ["recommendation_blocked"] }),
